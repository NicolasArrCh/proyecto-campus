        ...
        <div style={{ display: currentPage === 'inicio' ? 'block' : 'none' }}>
          ...
          <section className="hero-section overflow-hidden">
            ...
            >
              ...
              >
                <a href="https://wa.link/05gr61" target="_blank" rel="noopener noreferrer" style={{ pointerEvents: 'auto', textDecoration: 'none' }}>
                  <div style={{
                    display: 'flex', alignItems: 'center', gap: '0.4rem',
                    background: 'rgba(37, 211, 102, 0.9)', color: 'white',
                    padding: '0.5rem 1rem', borderRadius: '20px',
                    fontWeight: 'bold', boxShadow: '0 4px 15px rgba(37, 211, 102, 0.4)',
                    animation: isMobile ? 'none' : 'bounceBubble 2s infinite ease-in-out',
