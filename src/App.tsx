        ...
        <>
          ...
          >
            ...
            <div className="hero-mascot-placeholder relative z-10" style={{ position: 'relative', width: '100%', maxWidth: '500px', aspectRatio: '1/1' }}>
              ...
              {/* Key fijo para evitar que el componente se desmonte/remonte y genere clon 2D */}
              <OrbitLienzo 
                key="orbit-mascot"
          ...
          {/* ── Visión & Misión Section (moved from programas) ── */}
          <motion.section
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="jornada-options-grid" style={{ marginBottom: '3rem' }}>
              ...
              {/* Ver Programas button — llevará a las cards de FormationsList */}
